    ...
    [
    	{
    		id: 1,
    		answers: [
    			new Result('quizQuestBlock-1', 1, 'Планирование и Декомпозиция целей', 'itog-testirovaniia', 'Ты нуждаешься в улучшении навыков планирования и декомпозиции. Это очень сильно ограничивает реализацию твоего потенциала. Если ты научишься правильно ставить цель и освоишь технику декомпозиции, то самая большая мечта начнет осуществляться. Я подготовил для тебя короткие мини-упражнения, которую ты можешь применить уже сегодня и получить практические навыки планирования и декомпозиции.', '', 0),
    			new Result('quizQuestBlock-1', 2, 'Планирование и Декомпозиция целей', 'itog-testirovaniia', 'Ты нуждаешься в улучшении навыков планирования и декомпозиции. Это очень сильно ограничивает реализацию твоего потенциала. Если ты научишься правильно ставить цель и освоишь технику декомпозиции, то самая большая мечта начнет осуществляться. Я подготовил для тебя короткие мини-упражнения, которую ты можешь применить уже сегодня и получить практические навыки планирования и декомпозиции.', '', 0),
    			new Result('quizQuestBlock-1', 3, 'Планирование и Декомпозиция целей', 'planirovanie-dekomp-tcelei', 'Ты выглядишь как человек, который умеет планировать и делает это часто и на автомате. Это очень важный навык, который помогает добиваться задуманного. Также ты умеешь эффективно разбивать большую цель на более мелкие подзадачи.', 'У тебя отличные шансы преуспеть!', 1),
	        ],
	    },
	    {
		    id: 2,
		    answers: [
			    new Result('quizQuestBlock-2', 1, 'Планирование и Декомпозиция целей', 'itog-testirovaniia', 'Ты нуждаешься в улучшении навыков планирования и декомпозиции. Это очень сильно ограничивает реализацию твоего потенциала. Если ты научишься правильно ставить цель и освоишь технику декомпозиции, то самая большая мечта начнет осуществляться. Я подготовил для тебя короткие мини-упражнения, которую ты можешь применить уже сегодня и получить практические навыки планирования и декомпозиции.', '', 0),
			    new Result('quizQuestBlock-2', 2, 'Планирование и Декомпозиция целей', 'itog-testirovaniia', 'Ты нуждаешься в улучшении навыков планирования и декомпозиции. Это очень сильно ограничивает реализацию твоего потенциала. Если ты научишься правильно ставить цель и освоишь технику декомпозиции, то самая большая мечта начнет осуществляться. Я подготовил для тебя короткие мини-упражнения, которую ты можешь применить уже сегодня и получить практические навыки планирования и декомпозиции.', '', 0),
			    new Result('quizQuestBlock-2', 3, 'Планирование и Декомпозиция целей', 'planirovanie-dekomp-tcelei', 'Ты выглядишь как человек, который умеет планировать и делает это часто и на автомате. Это очень важный навык, который помогает добиваться задуманного. Также ты умеешь эффективно разбивать большую цель на более мелкие подзадачи.', 'У тебя отличные шансы преуспеть!', 1),
		    ],
	    },
	    {
		    id: 3,
		    answers: [
			    new Result('quizQuestBlock-3', 1, 'Волшебный пендель', 'volshebnyi-pendel', 'Поздравляю! Ты принадлежишь к тем 2% очень целеустремленных людей, которые умеют управлять собой и могут мотивировать себя самостоятельно. И я по-хорошему тебе завидую, ведь таких людей очень мало. Буду рад познакомиться с тобой лично.', 'У тебя большие шансы достичь небывалых высот и даже стать президентом!', 1),
			    new Result('quizQuestBlock-3', 2, 'Волшебный пендель', 'volshebnyi-pendel', 'Похоже, тебе необходим волшебный пендель. Я могу сказать, что ты не одинок: в нем нуждаются 98% населения, включая успешных людей. Радуйся, у меня есть для тебя очень простое и эффективное супер-решение.', '', 0),
			    new Result('quizQuestBlock-3', 3, 'Волшебный пендель', 'volshebnyi-pendel', 'Похоже, тебе необходим волшебный пендель. Я могу сказать, что ты не одинок: в нем нуждаются 98% населения, включая успешных людей. Радуйся, у меня есть для тебя очень простое и эффективное супер-решение.', '', 0),
		    ],
	    },
	    {
		    id: 4,
		    answers: [
			    new Result('quizQuestBlock-4', 1, 'Отсутствие новизны', 'otsutstvie-novizny', 'Отлично! По итогам теста я вижу, что ты считаешь свою жизнь эмоциональной, яркой и насыщенной. Разнообразие в жизни придает тебе дополнительную энергию для продвижения к своим целям. Я рад, что у тебя  в этом отношении все хорошо.', 'Твоя эффективность — 100%. Ты способен быстро достигать целей, добиваться успеха!', 1),
			    new Result('quizQuestBlock-4', 2, 'Отсутствие новизны', 'otsutstvie-novizny', 'Ты считаешь свою жизнь однообразной, скучной и неинтересной. Ты бегаешь по замкнутому кругу, и ничего нового не происходит. Ты недополучаешь энергию, поэтому не можешь быстро продвигаться к своим целям, создавать жизнь своей мечты.', '', 0),
			    new Result('quizQuestBlock-4', 3, 'Отсутствие новизны', 'otsutstvie-novizny', 'Ты считаешь свою жизнь однообразной, скучной и неинтересной. Ты бегаешь по замкнутому кругу, и ничего нового не происходит. Ты недополучаешь энергию, поэтому не можешь быстро продвигаться к своим целям, создавать жизнь своей мечты.', '', 0),
		    ],
	    },
	    {
		    id: 5,
		    answers: [
			    new Result('quizQuestBlock-5', 1, 'Навыки социального взаимодействия', 'navyki-sotcialnogo-vzaimodeistviia', 'С этим пунктом беда у абсолютного большинства людей, родившихся после 1995 года. Почему так происходит и что с этим делать, я рассказываю в этом коротком видео.', 'подвал ответа - 1', 0),
			    new Result('quizQuestBlock-5', 2, 'Навыки социального взаимодействия', 'navyki-sotcialnogo-vzaimodeistviia', 'С этим пунктом беда у абсолютного большинства людей, родившихся после 1995 года. Почему так происходит и что с этим делать, я рассказываю в этом коротком видео.', 'подвал ответа - 1', 0),
			    new Result('quizQuestBlock-5', 3, 'Навыки социального взаимодействия', 'navyki-sotcialnogo-vzaimodeistviia', 'Превосходно! Ты легко находишь общий язык с людьми. У тебя широкий круг общения, есть с кем посоветоваться и от кого получить поддержку.', 'Ты счастливый человек!', 1),
		    ],
	    },
	    {
		    id: 6,
		    answers: [
			    new Result('quizQuestBlock-6', 1, 'Энергия и спорт', 'energiia-i-sport', 'Молодец! Я рад, что у тебя все здорово. Судя по ответам, ты спортивный, энергичный человек. Большинство успешных людей занимаются спортом. И это не просто так. Спорт действительно дает ту базовую жизненную энергетику, которая позволяет людям добиваться больших результатов.', 'У тебя сформированы базовые навыки для достижения успеха!', 1),
			    new Result('quizQuestBlock-6', 2, 'Энергия и спорт', 'energiia-i-sport', 'Все мы знаем, что спорт крайне важен. Почти все успешные люди занимаются каким-либо видом спорта. И это не просто так. Спорт действительно качает базовую энергию и энергетику, которая нужна, чтобы менять свою жизнь и мир вокруг себя.', '', 0),
			    new Result('quizQuestBlock-6', 3, 'Энергия и спорт', 'energiia-i-sport', 'Все мы знаем, что спорт крайне важен. Почти все успешные люди занимаются каким-либо видом спорта. И это не просто так. Спорт действительно качает базовую энергию и энергетику, которая нужна, чтобы менять свою жизнь и мир вокруг себя.', '', 0),
		    ],
	    },
    ];
